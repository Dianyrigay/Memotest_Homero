...
def crear_tarjeta(nombre_imagen: str, identificador: int, nombre_imagen_escondida: str, x: int, y: int) -> dict:
    ...
    tarjeta["superficie"] = pygame.transform.scale(imagen, (ANCHO_TARJETA, ALTO_TARJETA))
    tarjeta["superficie_escondida"] = pygame.transform.scale(imagen_escondida, (ANCHO_TARJETA, ALTO_TARJETA))
